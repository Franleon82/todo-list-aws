...
#BASE_URL = "https://937i0qhtij.execute-api.us-east-1.amazonaws.com/Prod"
print(BASE_URL)
...
class TestApi(unittest.TestCase):
    ...
    def test_api_translatetodo(self):
        ...
        self.assertEqual(
            json_response['text'], "Ejemplo de texto de integraci\u00f3n: TRANSLATE", "Error en la petici\u00f3n API a {url}"
        )
        #Delete TODO to restore state
        url = BASE_URL + "/todos/" + ID_TODO
        response = requests.delete(url)
